...
export const FeaturedHighlights: React.FC<FeaturedHighlightsProps> = ({ items }) => {
    return (
        <section className="w-full py-16 bg-forest text-cornsilk">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="font-serif text-4xl md:text-5xl uppercase tracking-widest mb-4">
                        Featured Moments
                    </h2>
                    ...
                    {items.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 flex items-center justify-center p-4">
                                <h3
                                    className="font-script text-5xl md:text-6xl text-cornsilk drop-shadow-lg transform -rotate-6 transition-transform duration-300 group-hover:-rotate-3 group-hover:scale-110"
